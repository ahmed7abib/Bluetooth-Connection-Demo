...
public class TesProMeterDataRetriever {

    private MeterData meterData;
    private final ConnectionHandler connectionHandler;
    private GetMeterDataCallback callback;

    public TesProMeterDataRetriever(BluetoothSocket bluetoothSocket) {
    ...
    private void writeBaudRate300() {
        connectionHandler.writing(ConnectionTypes.baudTran_300_7, 16);
        Utils.sleep(30);
        writeInitPacket();
    }
